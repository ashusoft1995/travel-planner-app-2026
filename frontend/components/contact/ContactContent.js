...
import { submitContactMessage, friendlyApiMessage } from "../../lib/api";
...
export default function ContactContent() {
  ...
  return (
    <main className="bg-white dark:bg-[#050b18] text-slate-900 dark:text-white min-h-screen py-24">
      <div className="container max-w-7xl">
        <div className="mb-16">
          <p className="text-[10px] font-black uppercase tracking-[0.4em] text-blue-600 mb-4">Personalized Assistance</p>
          <h1 className="text-6xl font-black text-[#051128] dark:text-white tracking-tighter mb-6 uppercase">Reach Out to Your <span className="text-blue-600">Concierge</span></h1>
        ...
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <motion.div 
            ...
            className="lg:col-span-7 bg-slate-50 dark:bg-white/5 rounded-[3rem] p-12 shadow-sm border border-slate-100 dark:border-white/10"
          >
            <form onSubmit={handleSubmit} className="space-y-10">
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-2xl px-6 py-4 text-slate-900 dark:text-white font-bold placeholder:text-slate-400 focus:ring-2 focus:ring-blue-500 transition-all outline-none"
                  />
                </div>
                <div>
                  ...
                  {["Ashu", "Jemile", "Bire", "Elsa"].map((admin) => (
                    <button
                      ...
                      className={`py-4 rounded-2xl font-black uppercase tracking-widest text-[10px] transition-all border-2 ${
                        ...
                        : "bg-white dark:bg-slate-900 border-slate-200 dark:border-white/10 text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-white/10"
                      }`}
                    >
                      {admin}
                    </button>
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-2xl px-6 py-6 text-slate-900 dark:text-white font-bold placeholder:text-slate-400 focus:ring-2 focus:ring-blue-500 transition-all resize-none outline-none"
                />
              </div>
          ...
          <div className="lg:col-span-5 space-y-8">
            <motion.div 
              ...
              className="bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/10 rounded-[3rem] p-10 space-y-10 shadow-sm"
            >
              <ContactInfoCard 
             ...
             <motion.div 
                ...
                className="relative h-[300px] rounded-[3rem] overflow-hidden bg-slate-200 shadow-sm border border-slate-100 dark:border-white/10"
             >
                <Image 
                ...
                />
                <div className="absolute inset-0 bg-[#051128]/20" />
                <div className="absolute inset-0 flex items-center justify-center">
                   <a 
                     href="https://www.google.com/maps/search/?api=1&query=Bole+Road+Mega+Building+Addis+Ababa+Ethiopia" 
                     target="_blank" 
                     rel="noopener noreferrer"
                     className="bg-white/90 dark:bg-[#050b18]/90 backdrop-blur-md px-6 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest text-[#051128] dark:text-white shadow-xl flex items-center gap-2 hover:bg-blue-600 hover:text-white transition-all transform hover:scale-105"
                   >
                     <FiNavigation className="text-blue-600 group-hover:text-white transition-colors" /> Open in Navigation
                   </a>
                </div>
             </motion.div>

            <div className="bg-slate-50 dark:bg-white/5 rounded-[2.5rem] p-10 border border-slate-100 dark:border-white/10 shadow-sm">
               ...
               <div className="space-y-4">
                  <div className="flex justify-between items-center text-xs font-black uppercase tracking-tighter text-[#051128] dark:text-white">
        ...
        <section className="mt-24 pt-24 border-t border-slate-100 dark:border-white/5">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-16">
            <div className="max-w-xl">
              <h3 className="text-4xl font-black text-[#051128] dark:text-white uppercase tracking-tighter mb-4">Meet Your <span className="text-blue-600">Personal Support</span> Team</h3>
            ...
            <div className="flex -space-x-4">
              {["Ashu", "Jemile", "Bire", "Elsa"].map((name, i) => (
                <div key={name} className={`relative h-20 w-20 rounded-full border-4 border-white dark:border-[#050b18] overflow-hidden shadow-sm z-${40 - i * 10}`}>
                   <Image 
              ...
              <div className="relative h-20 w-20 rounded-full border-4 border-white dark:border-[#050b18] bg-blue-600 flex items-center justify-center shadow-sm z-0">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={member.name} className="bg-slate-50 dark:bg-white/5 p-6 rounded-[2rem] border border-slate-100 dark:border-white/10 flex items-center justify-between group hover:shadow-sm hover:border-blue-600 transition-all">
                <div>
                ...
                <button className="h-10 w-10 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 flex items-center justify-center text-[#051128] dark:text-white group-hover:bg-blue-600 group-hover:text-white group-hover:border-blue-600 transition-all">
                  <FiSend size={14} />
                </button>
              </div>
            ))}
        ...
        <section className="mt-32">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              <div key={office.city} className="group relative h-[350px] rounded-[3rem] overflow-hidden shadow-lg border border-slate-100 dark:border-white/10">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#051128]/90 via-[#051128]/40 to-transparent" />
                <div className="absolute bottom-10 left-10">
                   <h4 className="text-3xl font-black text-white uppercase tracking-tighter mb-2">{office.city}</h4>
                   <p className="text-white/70 text-xs font-bold uppercase tracking-widest leading-relaxed mb-4 max-w-[250px]">{office.addr}</p>
        ...
        <section className="mt-32 mb-16">
           <div className="bg-slate-50 dark:bg-white/5 rounded-[4rem] p-16 lg:p-24 border border-slate-100 dark:border-white/10 shadow-sm">
        ...
        {/* Footer Meta */}
        <footer className="mt-32 pt-16 border-t border-slate-100 dark:border-white/5">
          <div className="flex flex-col md:flex-row justify-between items-start gap-12">
            <div>
              <p className="text-2xl font-black text-[#051128] dark:text-white uppercase">EthioTravel</p>
              <p className="text-sm text-slate-500 dark:text-slate-400 mt-4 max-w-xs font-medium">Crafting bespoke adventures across the historic and natural wonders of Ethiopia since 2012.</p>
              <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mt-8">© 2026 EthioTravel. All rights reserved.</p>
            </div>
            <div className="grid grid-cols-3 gap-16">
              <div>
                <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-6">Company</p>
                <ul className="space-y-3 text-[10px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-400">
...
function ContactInfoCard({ icon, title, desc, sub }) {
  return (
    <div className="flex gap-6">
      <div className="h-12 w-12 rounded-2xl bg-white dark:bg-slate-900 flex items-center justify-center shadow-sm shrink-0 border border-slate-200 dark:border-white/10">
        {icon}
      </div>
      <div>
        <h4 className="text-sm font-black text-[#051128] dark:text-white uppercase mb-1">{title}</h4>
        <p className="text-xs text-slate-500 dark:text-slate-400 font-medium leading-relaxed max-w-[200px]">{desc}</p>
